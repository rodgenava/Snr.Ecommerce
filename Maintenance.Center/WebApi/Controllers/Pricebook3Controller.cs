...
namespace WebApi.Controllers
{
    ...
    [ApiController]
    public class Pricebook3Controller : ControllerBase
    {
        private readonly IMediator _mediator;

        public Pricebook3Controller(IMediator mediator)
        {
            _mediator = mediator;
        }
        ...
        public async Task<IActionResult> Template(CancellationToken token)
        {
            ...
            return File(
                ...
                fileDownloadName: "Pricebook 3 Template.xlsx");
        }
        ...
        public async Task<IActionResult> PromotionsTemplate(CancellationToken token)
        {
            ...
            return File(
                fileContents: templateBytes,
                contentType: System.Net.Mime.MediaTypeNames.Application.Octet,
                fileDownloadName: "Pricebook 3 Promotions Template.xlsx");
        }
