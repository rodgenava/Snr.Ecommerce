...
namespace Infrastructure.Data.Pricebook3.View
{
    public class PromotionListItemsPagedQuery : IAsyncQuery<IEnumerable<PromotionListItem>, PromotionListItemsPagedRequest>
    {
        ...
        {
            string query = "With OrderedSet As (Select Row_Number() Over (Order By {PART_SORT_ORDER}) As ResultOrdinal,Store,Sku,[Description],HighestCost,HighestRegularPrice,EventNumber,Price As PromoPrice,MarginPercent As Margin,PriceDifferencePercent As PriceDifference,EventBegin,EventEnd,Apply From Pricebook3PromotionsWithCalculatedMargins {PART_INTERNAL_SEARCH}) Select Store,Sku,[Description],HighestCost,HighestRegularPrice,EventNumber,PromoPrice,Margin,PriceDifference,EventBegin,EventEnd,Apply From OrderedSet OS ";
